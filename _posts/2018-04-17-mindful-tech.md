---
layout: post
title: "Mindful tech: 22 concrete tips"
...
> ![](../images/mf-tec/white-wallpaper.png)
> _White wallpaper, before and after (with Nova Launcher)_
...
### Nova launcher
Use this custom Android launcher[^siempo] to
...
> _Removing the search bar, before and after_


> ![](../images/mf-tec/grid-size-before-after.png)
> _Setting the drawer app grid, before and after_


## Black and white
You can manually set your phone to black and white in the following way. Go to [developer options](https://www.google.co.uk/search?q=enable+developer+options+android), then ``Hardware-accelerated rendering`` and set ``Simulate colour space`` to ``Monochrome``. 

> ![](../images/mf-tec/bw-before-after.png)
> _Black and white, before and after_

But colour has genuine uses, like viewing photos. You may also want to keep colour for "virtuous" apps like Headspace. By using [Tasker](https://play.google.com/store/apps/details?id=net.dinglisch.android.taskerm&hl=en), you can actually automate when the grayscale setting is turned on or off. 
...
You can import my setup by simply clicking [this link](https://taskernet.com/shares/?user=AS35m8nQtNGNf5aJoWclVV5G6TU4rgIiipYP6y3LtnAoqMq2T5WPVZMQlUCnTqbiF8E%3D&id=Project%3Abw) from an Android device that has Tasker installed ([XML backup](../files/mf-tec/bw.prj.xml)).
...
> <img src="../images/mf-tec/lockedfor.png" style="max-height: 400px;"/>
> 
> _Keeping track of how long your phone has been locked_


This is extremely inexpertly built; if I remember correctly it just writes the date & time to a file every time you lock or unlock the phone. The need to write to a file is to avoid resetting your counter when you turn off your phone. You can import the Tasker project by clicking [this link](https://taskernet.com/shares/?user=AS35m8nQtNGNf5aJoWclVV5G6TU4rgIiipYP6y3LtnAoqMq2T5WPVZMQlUCnTqbiF8E%3D&id=Project%3Alockedfor) from an Android device that has Tasker installed ([XML backup](../files/mf-tec/lockedfor.prj.xml)).

## Block all notifications 
I built another Tasker project that relies on [AutoNotification](https://play.google.com/store/apps/details?id=com.joaomgcd.autonotification&hl=en) to block some apps' notifications (e.g. WhatsApp), and then unblock them again. 
...
Warning: this is some hacky shit, very brittle, I don't really understand how it handles device reboots. If you're brave enough to try: [Magic Tasker link](https://taskernet.com/shares/?user=AS35m8nQtNGNf5aJoWclVV5G6TU4rgIiipYP6y3LtnAoqMq2T5WPVZMQlUCnTqbiF8E%3D&id=Project%3Ablocknotif), [XML backup](../files/mf-tec/blocknotif.prj.xml).
...
# Browser
## Grayscale the Web
Install [Grayscale the Web](https://chrome.google.com/webstore/detail/grayscale-the-web-save-si/mblmpdpfppogibmoobibfannckeeleag?hl=en). Navigate to the distracting website, and click ``Save Site``. (You have to do this manually for every offending domain).

> ![](../images/mf-tec/grayscale-web.png)
> _Grayscale the web, before and after_
