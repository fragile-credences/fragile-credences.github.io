...
You can follow along with all the tests described in this post using [this file](/files/bayesblog.py), whereas the code doing the calculations for the webapp is [here](https://github.com/tmkadamcz/bayes-continuous/blob/master/bayes.py).
